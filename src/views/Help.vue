<template>
  <div class="columns">
      <div class="column scheme">
        ...
        <div class="help-info">
          Перед началом использования программы необходимо загрузить базу
        </div>
        ...
        <div class="help-info">
          Экспорт всей базы осуществляется при переходе во вкладку "Помощь" и клике на кнопку "Экспорт базы данных".
          При клике на эту кнопку при открытом стеллаже (или открытой ячейке) будет осуществлен экспорт по выбранному стелажу/ячейке
        </div>
        <div class="help-info">
          После того, как внесены изменения в базу, ее необходимо выгрузить (кнопка "Экспорт базы данных" на вкладе "Помощь")
        </div>
...
@Options({
  data() {
    return {
      fileName: 'Загрузите файл базы данных'
    }
  },
  methods: {
    ...mapGetters({
